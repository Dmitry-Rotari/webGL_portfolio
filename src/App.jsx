...
export default function App() {
  ...
  useEffect(() => {
    ...
    // IntersectionObserver to detect when the user scrolls to the end
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting && loaded) {
          // Play the sound when the end is reached and world.glb is loaded
    ...
    <>
      ...
      <div className="contact-footer">
        <div className="contact-icons">
          <a
            href="https://github.com/Dmitry-Rotari"
            target="_blank"
          ...
          <a href="mailto:dmitrydev415@gmail.com" aria-label="Email Contact">
            <i className="fas fa-envelope"></i>
          </a>
          <a
            href="/CV/Dumitru_Rotari.pdf"
            target="_blank"
            rel="noopener noreferrer"
          >
